...
//code heavily used from gram.gs/gramlog/creating-node-based-editor-unity/
...
public class ScriptNodeEditor : EditorWindow {
    ...
    private static void OpenWindow() {
        ScriptNodeEditor window = GetWindow<ScriptNodeEditor>();
    ...
    private void ProcessEvents(Event e) {
        ...
        switch (e.type) {
            case EventType.MouseDown:
                //if we right-click, open the "add node" menu
                if (e.button == 1) {
    ...
    private void OnClickRemoveNode(ScriptNode node) {
        if (connections != null) {
    ...
    //allows you to preiview the line you are drawing
